...
% Plot UCAV path
p4 = plot(xUCAV/1000,yUCAV/1000, 'Color', [0.1 0.1 0.8]);
hold off;

% Add legend
legend([p1 p2 p3 p4], 'True target location', 'Estimated target location', 'SAR image', 'UCAV path', 'Location','southwest');
legend('boxoff');
